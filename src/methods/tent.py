...
class Tent(nn.Module):
    ...
    def configure_model(model):
        ...
        """For cifar100-c"""
        # model.conv_1_3x3.weight.requires_grad = True
        ...
        # model.block2.layer[0].conv1.weight.requires_grad = True
        # model.block2.layer[0].conv2.weight.requires_grad = True
        # model.block2.layer[1].conv1.weight.requires_grad = True
        # model.block2.layer[1].conv2.weight.requires_grad = True
        # model.block2.layer[2].conv1.weight.requires_grad = True
        # model.block2.layer[2].conv2.weight.requires_grad = True
        # model.block2.layer[3].conv1.weight.requires_grad = True
        # model.block2.layer[3].conv2.weight.requires_grad = True
        # model.block3.layer[0].conv1.weight.requires_grad = True
        # model.block3.layer[0].conv2.weight.requires_grad = True
        # model.block3.layer[1].conv1.weight.requires_grad = True
        # model.block3.layer[1].conv2.weight.requires_grad = True
        # model.block3.layer[2].conv1.weight.requires_grad = True
        # model.block3.layer[2].conv2.weight.requires_grad = True
        # model.block3.layer[3].conv1.weight.requires_grad = True
        # model.block3.layer[3].conv2.weight.requires_grad = True
    ...
    def collect_params(model):
        ...
        for nm, m in model.named_modules():
            if isinstance(m, nn.BatchNorm2d) or isinstance(m, nn.LayerNorm) or isinstance(m, nn.Conv2d):
